          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            >
              ...
              <a
                ...
                aria-label="LinkedIn"
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#0070f3] hover:shadow-[0_0_12px_rgba(0,112,243,0.3)] transition-all"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#38bdf8] hover:shadow-[0_0_12px_rgba(56,189,248,0.3)] transition-all"
              >
              ...
              <a
                ...
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#2f8d46] hover:shadow-[0_0_12px_rgba(47,141,70,0.3)] transition-all"
              >
                <span className="font-bold text-[#2f8d46] font-mono text-base">GFG</span>
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LeetCode"
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#ffa116] hover:shadow-[0_0_12px_rgba(255,161,22,0.3)] transition-all"
              >
                <span className="font-bold text-[#ffa116] font-mono text-base">LC</span>
                <span>LeetCode</span>
              </a>
              ...
              <a
                ...
                aria-label="Email"
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#38bdf8] transition-all"
              >
