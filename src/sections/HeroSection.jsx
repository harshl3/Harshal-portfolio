...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{ paddingTop: "clamp(5.5rem, 14vw, 8.5rem)", paddingBottom: "clamp(3.5rem, 8vw, 5.5rem)" }}
    >
      ...
      <div className="section-container w-full relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <motion.div
              className="flex flex-wrap items-center justify-center lg:justify-start gap-2 mb-7 text-lg sm:text-2xl md:text-3xl font-semibold"
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.25 }}
            >
              <span className="text-slate-400 font-normal">I build</span>
              <span className="text-[#5cc8ff] font-mono min-w-[160px] sm:min-w-[220px] text-left font-semibold">
                {displayed}
            ...
            {/* CTA Buttons */}
            <motion.div
              className="flex flex-wrap items-center justify-center lg:justify-start gap-3.5 mb-9"
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <a
                ...
                download
                className="btn-secondary py-3 px-6 rounded-xl text-sm font-medium flex items-center gap-2"
              >
                <Download size={16} />
                <span>Resume</span>
              </a>
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-slate-400 hover:text-[#5cc8ff] transition-colors py-2 px-3 ml-1"
              >
            ...
            >
              <span className="text-xs text-slate-500 font-mono mr-0.5">PROFILES:</span>
              ...
              <a
                ...
                aria-label="LinkedIn"
                className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#0070f3] hover:shadow-[0_0_12px_rgba(0,112,243,0.3)] transition-all"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-current text-[#0077b5]" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#38bdf8] hover:shadow-[0_0_12px_rgba(56,189,248,0.3)] transition-all"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#2f8d46] hover:shadow-[0_0_12px_rgba(47,141,70,0.3)] transition-all"
              >
                <span className="font-bold text-[#2f8d46] font-mono text-sm sm:text-base">GFG</span>
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LeetCode"
                className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#ffa116] hover:shadow-[0_0_12px_rgba(255,161,22,0.3)] transition-all"
              >
                <span className="font-bold text-[#ffa116] font-mono text-sm sm:text-base">LC</span>
                <span>LeetCode</span>
              </a>
              ...
              <a
                ...
                aria-label="Email"
                className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#0b1224] border border-slate-800 text-slate-300 hover:text-white hover:border-[#38bdf8] transition-all"
              >
          ...
          >
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 flex items-center justify-center">
              ...
              <motion.div
                className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full overflow-hidden p-1.5 shadow-[0_0_40px_rgba(0,112,243,0.35)]"
                style={{
              ...
              <motion.div
                className="absolute top-1 -right-1 sm:top-2 sm:-right-4 px-2.5 py-1.5 rounded-xl text-[0.65rem] sm:text-xs font-bold text-white flex items-center gap-1.5 shadow-2xl"
                style={{
              ...
              <motion.div
                className="absolute bottom-3 -left-1 sm:bottom-4 sm:-left-4 px-2.5 py-1.5 rounded-xl text-[0.65rem] sm:text-xs font-bold text-white flex items-center gap-1.5 shadow-2xl"
                style={{
                  background: "rgba(10, 16, 32, 0.92)",
                  border: "1px solid rgba(56, 189, 248, 0.35)",
                  backdropFilter: "blur(14px)",
